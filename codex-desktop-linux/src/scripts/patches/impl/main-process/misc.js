...
const linuxHostProcessEnvironmentHelper =
  "function codexLinuxStripExportedShellFunctions(e){for(let t of Object.keys(e))t.startsWith(`BASH_FUNC_`)&&t.endsWith(`%%`)&&delete e[t];return e}function codexLinuxHostProcessEnv(e){let t={...e},n=process.env.CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE,r=n==null?void 0:process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE??n,o=process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE==null?process.env.CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_VALUE:process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE;r===`unset`?delete t.LD_LIBRARY_PATH:r===`empty`?t.LD_LIBRARY_PATH=``:r===`value`&&typeof o==`string`&&(t.LD_LIBRARY_PATH=o);for(let e of[`CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE`,`CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_VALUE`,`CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE`,`CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE`])delete t[e];return codexLinuxStripExportedShellFunctions(t)}function codexLinuxLoginShellExtraEnv(e){let t=codexLinuxHostProcessEnv(e),n=process.env.CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE,r=n==null?void 0:process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE??n;return r===`unset`&&(t.LD_LIBRARY_PATH=void 0),t}function codexLinuxShellEnvResult(e){let t={...e},n=process.env.CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE;n!=null&&(Object.hasOwn(t,`LD_LIBRARY_PATH`)?t.LD_LIBRARY_PATH===``?(process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE=`empty`,delete process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE):(process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE=`value`,process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE=t.LD_LIBRARY_PATH):(process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE=`unset`,delete process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE),delete t.LD_LIBRARY_PATH);for(let e of[`CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE`,`CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_VALUE`,`CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE`,`CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE`])delete t[e];return codexLinuxStripExportedShellFunctions(t)}";
const legacyLinuxHostProcessEnvironmentHelperRegex =
  /function codexLinuxHostProcessEnv\(e\)\{[^]*?function codexLinuxShellEnvResult\(e\)\{[^]*?return t\}/;
...
function applyLinuxHostProcessEnvironmentPatch(currentSource) {
  ...
  if (currentSource.includes(marker)) {
    if (currentSource.includes("function codexLinuxStripExportedShellFunctions(")) {
      return currentSource;
    }
    return currentSource.replace(
      legacyLinuxHostProcessEnvironmentHelperRegex,
      linuxHostProcessEnvironmentHelper,
    );
  }
  ...
  const helper = linuxHostProcessEnvironmentHelper;

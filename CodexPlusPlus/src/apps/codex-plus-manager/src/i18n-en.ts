...
export const EN_PLAIN: Record<string, string> = {
  ...
  "浏览器后台实例": "Browser background instance",
  "浏览器端口必须位于 49152-65535。": "The browser port must be between 49152 and 65535.",
  "变更端口时需要填写端口号。": "Enter a port number before changing the port.",
  "访问地址已复制。": "Access URL copied.",
  "ChatGPT OAuth": "ChatGPT OAuth",
  "Pure API": "Pure API",
  "混合 API": "Mixed API",
  "未认证": "Not authenticated",
  "未启动独立的 tmux / Xvfb 实例": "No dedicated tmux / Xvfb instance has been started",
  "认证模式": "Authentication mode",
  "查看完整进程列表": "View the full process list",
  "全部": "All",
  "复制访问地址": "Copy access URL",
  "浏览器端口": "Browser port",
  "留空时自动选择高位端口": "Leave empty to choose a high port automatically",
  "正在变更端口": "Changing port",
  "变更端口": "Change port",
  "正在终止": "Stopping",
  "终止实例": "Stop instance",
  "正在启动": "Starting",
  "后台启动": "Start in background",
  "仅监听 127.0.0.1；远程访问请使用 SSH 端口转发。": "Listening on 127.0.0.1 only; use SSH port forwarding for remote access.",
  "启动中": "Starting",
  "降级运行": "Degraded",
  "变更中": "Reconfiguring",
  "终止中": "Stopping",

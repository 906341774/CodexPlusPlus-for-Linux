...
Project version: `1.2.34`, synchronized with upstream Codex++ `v1.2.34`.
...
unless both build-info files record the exact discovered set. The `v1.2.34`
baseline currently enables 23 Linux features; `Enabled features: None` is a
hard build failure.
